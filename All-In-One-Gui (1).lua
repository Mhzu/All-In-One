...
local OldGui = PlayerGui:FindFirstChild("StickyToggle")
if OldGui then
    OldGui:Destroy()
end
    ...
    function self:CreateTab(TabName)
        ...
        function Tab:CreateKeybind(Text, DefaultKey, Callback)
            ...
            local function IsBindableInput(Input)
                if not Input or not Input.KeyCode or Input.KeyCode == Enum.KeyCode.Unknown then
                    return false
                end
                local uit = Input.UserInputType
                return uit == Enum.UserInputType.Keyboard
                    or uit == Enum.UserInputType.Gamepad1
            ...
            UserInputService.InputBegan:Connect(function(Input, GameProcessed)
                ...
                if not GameProcessed and IsBindableInput(Input)
